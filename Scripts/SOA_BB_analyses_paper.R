...
### READ DATA
dc<-read.csv("/Users/louise/Documents/GitHub/SOA-project-/scripts/Python/N72_concat.csv", header=T, sep=";", dec = ".")
df<-read.csv("/Users/louise/Documents/GitHub/SOA-project-/scripts/Python/N72_B.csv", header=T, sep=";", dec = ".")
ph<-read.csv("/Users/louise/Documents/GitHub/SOA-project-/scripts/Python/N72_phases.csv", header=T, sep=";", dec = ".")
...
### FIGURE 2C & S5 - x="M_minus_NM", ["zf0_Original"] ["f0m_NM"]
...
### S3 : MAGNITUDE MODEL : zf0c_Original_abs ~ condition * age
dc$cond <- factor(as.character(dc$cond), levels=c("p100", "neutre","m100"))
contrasts(dc$cond) <- contr.treatment(3)
contrasts(dc$cond)
dc$agex <- dc$age
